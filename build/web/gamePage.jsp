<%-- 
    Document   : gamePage
    Created on : Mar 11, 2025, 3:28:22 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body class="d-flex flex-column" style ="height: auto">
      ...
      <div class = "container mb-3 mt-3">
          <h1 class ="text-center">${gamedata.title}</h1>
      </div>
        
      <!-- comment -->
      <div class ="container w-75">
          <div class ="row">
            <div class ="col border-end rounded-3 me-1 bg-light p-1" style= "height: auto;">
              <img src="${gamedata.image}" class="img-fluid rounded-3" alt="...">
            </div>
            <div class ="col border-end rounded-3 ms-1 bg-light p-1 overflow-y-scroll p-4" style ="max-height: 300px;">
                <h4 class="text-success">About: ${gamedata.title}</h4>
                ${gamedata.description}
            </div>  
          </div>
          <div class ="row border d-flex text-center mt-1 rounded-3 bg-light" style= "height: 300px">
            <div class ="row border-bottom" style= "height: auto">  
                <div class = "col border-end d-flex align-items-center justify-content-center">
                    <h1>Link megaup</h1>
                </div>
                <div class = "col mt-5">
                    <h1><a href ="${gamedata.megaup}">megaup.com</a></h1>
                </div>
            </div> 
            <div class ="row border-bottom d-flex align-items-center justify-content-center" style= "height: auto">  
                <div class = "col border-end">                   
                    <h1>Link Gofile</h1>
                </div>
                <div class = "col mt-1">
                    <h1><a href ="${gamedata.gofile}">Gofile.com</a></h1>
                </div>
            </div> 
          </div>
