<%-- 
    ...
    Created on : Mar 11, 2025, 5:27:06 PM
    Author     : Admin
--%>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name ="nameforedit" class="form-control" value="${userdata.username}">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Password</label>
                                                        <input type="text" name ="passforedit" class="form-control" value="${userdata.password}">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Email</label>
                                                        <input type="email" name ="emailforedit" class="form-control" value="${userdata.email}" disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label">Phone</label>
                                                        <input type="tel" name = "phoneforedit" class="form-control" value="0${userdata.phone}">
                                                    </div>
                                                    <div class="col-12">
                                            ...
                                            <p class="text-danger ms-5">${updateErr}</p>
                                            <p class="text-success ms-5">${updateSuccess}</p>
                                            <c:remove var="updateSuccess"/>
                                            <c:remove var="updateErr"/>
                                            <div class ="d-flex flex-row-reverse me-3 mb-4"><button type="submit" class="btn btn-outline-primary">update</button></div>
                                        </form>
                                    </div>                                       
                                </div>
                            </div>
